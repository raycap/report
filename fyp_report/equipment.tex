...
In this project, necessary equipments, software, and robotic arm that are going to be used are: 1 $\times$ Denso VS060A3-AV6 arm, 1 $\times$ end-effector handle, 1 $\times$ ATI Gamma F/T Sensor (SI-32-2.5 calibration), 1 $\times$ Robotiq gripper, Ubuntu 12.04 LTS, OpenRave, and Denso ROS. 
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.4\textwidth ]{robotiq_gripper}
